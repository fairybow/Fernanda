...
- [ ] Coco CMake?
- [ ] Replace bit7z with miniz
- [ ] Remove 7-Zip type from MagicBytes and FileTypes
- [ ] Check for other bit7z/7-Zip references
- [ ] Is a Path c_str equivalent possible? (I've tried before) (If so, replace in miniz code)
