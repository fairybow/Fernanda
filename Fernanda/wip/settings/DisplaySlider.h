...
private:
    ...
    void initialize_()
    {
        ...
        connect(slider_, &QSlider::rangeChanged, this, [&](int min, int max) { emit rangeChanged(min, max); });
        connect(slider_, &QSlider::sliderMoved, this, [&](int value) { emit sliderMoved(value); });
        connect(slider_, &QSlider::sliderPressed, this, [&]() { emit sliderPressed(); });
        connect(slider_, &QSlider::sliderReleased, this, [&]() { emit sliderReleased(); });
    }
