...
echo f|xcopy /v /y /f "qweb_icudtl" "%data%\icudtl.dat"
...
echo f|xcopy /v /y /f "qt_opengl" "%data%\Qt6OpenGL.dll"
echo f|xcopy /v /y /f "qt_positioning" "%data%\Qt6Positioning.dll"
echo f|xcopy /v /y /f "%qt_printsupport%" "%data%\Qt6PrintSupport.dll"
echo f|xcopy /v /y /f "qt_qml" "%data%\Qt6Qml.dll"
echo f|xcopy /v /y /f "qt_qmlmodels" "%data%\Qt6QmlModels.dll"
echo f|xcopy /v /y /f "qt_quick" "%data%\Qt6Quick.dll"
echo f|xcopy /v /y /f "qt_quickwidgets" "%data%\Qt6QuickWidgets.dll"
echo f|xcopy /v /y /f "qt_webchannel" "%data%\Qt6WebChannel.dll"
echo f|xcopy /v /y /f "qt_wecore" "%data%\Qt6WebEngineCore.dll"
echo f|xcopy /v /y /f "qt_wewidgets" "%data%\Qt6WebEngineWidgets.dll"
echo f|xcopy /v /y /f "%qt_widgets%" "%data%\Qt6Widgets.dll"
echo f|xcopy /v /y /f "%qt_xml%" "%data%\Qt6Xml.dll"
echo f|xcopy /v /y /f "qweb_r1" "%data%\qtwebengine_devtools_resources.pak"
echo f|xcopy /v /y /f "qweb_r2" "%data%\qtwebengine_resources.pak"
echo f|xcopy /v /y /f "qweb_r3" "%data%\qtwebengine_resources_100p.pak"
echo f|xcopy /v /y /f "qweb_r4" "%data%\qtwebengine_resources_200p.pak"
echo f|xcopy /v /y /f "qweb_exe" "%data%\QtWebEngineProcess.exe"
